const Resources = require('../models/resource.js')
...
exports.addBook = async (req,res)=>{
    ...
    const subObj = await Resources.findById(subject);
...
exports.deleteBook = async (req, res) => {
    try {
        ...
        const result = await Resources.updateOne({ _id: id }, { $set: { books: updatedbooks } });
...
exports.deleteVideo = async (req, res) => {
    try {
        ...
        const result = await Resources.updateOne({ _id: id }, { $set: { videos: updatedvideos } });
...
exports.deleteNote = async (req, res) => {
    try {
        ...
        const result = await Resources.updateOne({ _id: id }, { $set: { notes: updatedNotes } });
